...
public class Ex {
	...
	public static void main(String[] args) {
		/*
		 * 조건문
		 * - 조건식 결과에 따라 실행할 문장이 달라지는 문(Statemnet)
		 ...
		 * 문장 3;
		 * 
		 * => 조건식 판별 결과 true  : 문장1 > 조건식(true ) > 문장3
		...
		if(num < 5) { // 조건식
			...
			System.out.println("num이 5보다 작다!"); // 문장 2
			
		}
		
		// if 문이 종료된 후 실행할 문장(조건식과 무관)
		...
		if(num2 < 0 ) { // 조건식
			// 조건식 결과가 true일 때(음수일 때) 실행 할 문장들...
			// 변수 num2 에 음수 부호(-)를 붙여서 다시 변수 num2에 저장
			
			num2 = -num2; //절대값으로 만들어라;
			System.out.println("음수를 양수로 변환!");
			
		}
		
		System.out.println("num의 절대값 : " + num2); // 문장 3
