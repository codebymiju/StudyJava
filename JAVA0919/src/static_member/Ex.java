...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 * - 참조변수 없이 클래스명만으로 멤버에 접근 가능함
		 * 	 (인스턴스 생성 없이도 접근 가능한 멤버)
		 *  => 기본 문법 : 클래스명.변수명 또는 클래스명.메서드명() 형태로 접근 가능
		 *
		 * < static 변수 >
		...
		System.out.printf("n1.a : %3d, n2.a : %d\n", n1.a, n2.a);
		System.out.printf("n1.b : %3d, n2.b : %d\n", n1.b, n2.b);
		
		// 즉, 인스턴스 멤버변수인 a와 b는 인스턴스마다 생성되므로
		// 하나의 인스턴스에서 인스턴스 멤버변수 값을 바꾸더라도
		// 다른 인스턴스 멤버변수에는 아무런 영향이 없다!
		// => 생성된 메모리 공간(heap)이 다르기 때문
		...
		StaticMember.a = 500; // 클래스명.변수명 = static 멤버변수 정의
