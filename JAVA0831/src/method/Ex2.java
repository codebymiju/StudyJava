...
public class Ex2 {
	...
	public static void main(String[] args) {
		...
		// 메서드 호출 코드에서 리턴되는 값을 전달받아 사용하거나 저장할 수 있음
//		String result = sister_2(); // sister_2() 메서드 호출 후 리턴값을 변수에 저장
		// sister_2() 메서드에서 "물"이라는 문자열을 리턴하므로 변수에 "물"저장
		// -> String result = "물"; 동일한 코드로 사용됨
//		System.out.println("동생이 떠다 준 것 : "+ result);
	...
	public static String sister_2() {
		System.out.println("동생 : 언니가 물 떠오라고 시켰다!");
		
		// 메서드 내에서 리턴값을 기술해야할 경우 return문을 명시하고 그 뒤에 데이터 지정
		// -> 이 때, 리턴할 데이터는 리터럴 또는 변수 또는 식 모두 사용 가능
		//    단, 리턴타입과 일치하는 데이터타입만 기술가능
...
//		System.out.println("메서드 끝!"); // 오류 발생! Unreachable code
		// -> return문 아래쪽에 기술되는 코드는 실행되지 못하므로 오류 발생!
