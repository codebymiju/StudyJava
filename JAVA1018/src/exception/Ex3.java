...
public class Ex3 {
	...
	public static void 팀장() throws Exception { // Exception안에 모든 예외 포함
...
//		}
	// 2. 메서드를 호출한 곳으로 throws 키워드를 통해 예외를 위임
	// => 현재 사원() 메서드를 호출한 곳(대리())으로 예외를 던짐(throws)
		...
		String str = null;
		System.out.println(str.length()); // NullPointerExceptin 발생하는 코드
...
//		try {
//			Class.forName(null); // ClassNotFoundException 발생하는 코드
//		} catch (ClassNotFoundException e) {
//			e.printStackTrace();
//		}
