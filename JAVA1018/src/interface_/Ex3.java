...
public class Ex3 {
	...
	public static void main(String[] args) {
		...
		pc.setPrinter(new LaserPrinter()); // LaserPrinter > printer 로 업캐스팅
		...
		// 현재 LaserPrinter를 InkjetPrinter 로 교체 시
...
class PrinterClient {
	...
	// print() 메서드를 호출한 뒤 파일을 전달받아 출력 작업을 수행
