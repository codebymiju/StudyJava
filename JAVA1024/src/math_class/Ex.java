...
public class Ex {
	...
	public static void main(String[] args) {
		...
		System.out.println(Math.ceil(dNum)); //소수점 첫째 자리에서 올림
		System.out.println(Math.floor(dNum)); // 소수점 첫째 자리에서 버림
		System.out.println(Math.round(dNum)); // 소수점 첫째 자리에서 반올림 (정수값이 리턴됨)
