...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 * - 오류(Error)와 달리 심각도가 낮으며, 예외 처리(Exception Handling)를 
		 * 	 통해 예외 발생 시 해결책을 기술하여 비정상적인 종료를 막을 수 있음
		 * - 예외 처리를 위해 try ~ catch 문을 사용하여 철
...
//		System.out.println(str.length());
		...
		try {
			// 예외가 발생할 것으로 예상되는 코드들을 try 블록 내에 위치 시킴
			int num = 1;
			System.out.println(3 / num);
