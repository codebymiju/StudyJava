...
public class Ex3 {
	...
	public static void main(String[] args) {
		 ...
		 *  
		 *  < 기본 문법 규칙 >
		 *  Wrapper클래스명.parse기본 데이터 타입명(문자열변수 또는 데이터)
...
//		int iNum = Integer.parseInt(strNum);
		// 문법적으로는 문제가 없지만 실행 시점에서 오류 발생
		// 실제 데이터가 실수이므로 정수형으로 변환이 불가능한 관계!
...
//		int i = 100.0; // int형 변수에 실수를 저장하지 못하는 것과 동일함
		...
		int iNum = Integer.parseInt(strNum); // Integer. - Wrapper 클래스
		// Wrapper 클래스 - 기본 데이터 타입을 객체화 시키는 클래스
